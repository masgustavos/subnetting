...
- Wait for an explicit go-ahead. "Hmm", "wait", a follow-up question, more spec or a free-text answer that is not a clear yes is not consent: update the plan and ask again.
